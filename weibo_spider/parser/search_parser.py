...
logger = logging.getLogger('spider.search_parser')


class SearchParser(Parser):
    def __init__(self, cookie, weibo_id):
        self.cookie = cookie
        self.url = 'https://weibo.cn/search/mblog?keyword=%23%s&page=%s'
    ...
    def __get_search_url(self, query, pn):
        return self.url % (query, pn)
